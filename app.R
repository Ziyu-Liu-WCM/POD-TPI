...
ui <- fluidPage(
  ...
  sidebarLayout(
    sidebarPanel(
      ...
      numericInput("n_d", "n_d:", value = 2),
      numericInput("m_d", "m_d:", value = 2),
      numericInput("r_d", "r_d:", value = 2),
      numericInput("p_T", "p_T:", value = 0.3),
      numericInput("epsilon1", "Epsilon 1:", value = 0.05),
      numericInput("epsilon2", "Epsilon 2:", value = 0.05),
      numericInput("niter", "niter:", value = 1000),
      ...
      numericInput("type_suspension", "Type Suspension:", value = 2),
      numericInput("q1", "q1:", value = 0),
      numericInput("q2", "q2:", value = 0.15),
